...
* **Telegram Integration** — full-featured interactive bot for server management via Telegram
* **Cloudflare WARP & Limits** — dual-VPN support via WARP and per-client speed limits
...
2.  **Download the script:**
    ```bash
    wget https://raw.githubusercontent.com/bootkiTdll/amneziawg-installer-fork/main/install_amneziawg_en.sh
    # or: curl -fLo install_amneziawg_en.sh https://raw.githubusercontent.com/bootkiTdll/amneziawg-installer-fork/main/install_amneziawg_en.sh
    ```
...
<details>
  ...
  <b>A:</b> No. AWG 2.0 is not compatible with AWG 1.x. All clients must support the 2.0 protocol. For AWG 1.x, use the <a href="https://github.com/bootkiTdll/amneziawg-installer-fork/tree/legacy/v4">legacy/v4</a> branch.
</details>
