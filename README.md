...
<p align="center">
  ...
  <a href="https://github.com/bootkiTdll/amneziawg-installer-fork/blob/main/LICENSE"><img src="https://img.shields.io/github/license/bootkiTdll/amneziawg-installer-fork" alt="License"></a>
  <img src="https://img.shields.io/badge/Status-Stable-success" alt="Status">
  <a href="https://github.com/bootkiTdll/amneziawg-installer-fork/releases"><img src="https://img.shields.io/badge/Installer_Version-5.8.0-blue" alt="Version"></a>
  <img src="https://img.shields.io/badge/AmneziaWG-2.0-blueviolet" alt="AWG 2.0">
  <a href="https://github.com/bootkiTdll/amneziawg-installer-fork/actions/workflows/shellcheck.yml"><img src="https://github.com/bootkiTdll/amneziawg-installer-fork/actions/workflows/shellcheck.yml/badge.svg" alt="ShellCheck"></a>
  <a href="https://github.com/bootkiTdll/amneziawg-installer-fork/stargazers"><img src="https://img.shields.io/github/stars/bootkiTdll/amneziawg-installer-fork?style=flat" alt="Stars"></a>
  <a href="https://github.com/bootkiTdll/amneziawg-installer-fork/network/members"><img src="https://img.shields.io/github/forks/bootkiTdll/amneziawg-installer-fork?style=flat" alt="Forks"></a>
  <img src="https://img.shields.io/github/last-commit/bootkiTdll/amneziawg-installer-fork" alt="Last commit">
</p>
...
```bash
wget https://raw.githubusercontent.com/bootkiTdll/amneziawg-installer-fork/main/install_amneziawg.sh
...
* **Интеграция с Telegram** — полноценный интерактивный бот для управления сервером через мессенджер
* **Cloudflare WARP и Лимиты** — поддержка двойного VPN через WARP и ограничение скорости для клиентов
...
2.  **Скачайте скрипт:**
    ```bash
    wget https://raw.githubusercontent.com/bootkiTdll/amneziawg-installer-fork/main/install_amneziawg.sh
    # или: curl -fLo install_amneziawg.sh https://raw.githubusercontent.com/bootkiTdll/amneziawg-installer-fork/main/install_amneziawg.sh
    ```
...
4.  **Запустите с `sudo`:**
    ...
    *(Вы также можете передать параметры командной строки, см. `sudo bash ./install_amneziawg.sh --help` или [ADVANCED.md#cli-params-adv](ADVANCED.md#cli-params-adv))*
    ...
    > ```bash
    > wget https://raw.githubusercontent.com/bootkiTdll/amneziawg-installer-fork/main/install_amneziawg_en.sh
...
<details>
  ...
  <b>О:</b> Нет. AWG 2.0 несовместим с AWG 1.x. Все клиенты должны поддерживать протокол 2.0. Для AWG 1.x используйте ветку <a href="https://github.com/bootkiTdll/amneziawg-installer-fork/tree/legacy/v4">legacy/v4</a>.
</details>
...
<details>
  ...
  <pre>
  # Русская версия:
  wget -O /root/awg/manage_amneziawg.sh https://raw.githubusercontent.com/bootkiTdll/amneziawg-installer-fork/main/manage_amneziawg.sh
  wget -O /root/awg/awg_common.sh https://raw.githubusercontent.com/bootkiTdll/amneziawg-installer-fork/main/awg_common.sh
  chmod 700 /root/awg/manage_amneziawg.sh /root/awg/awg_common.sh

  # Английская версия:
  wget -O /root/awg/manage_amneziawg.sh https://raw.githubusercontent.com/bootkiTdll/amneziawg-installer-fork/main/manage_amneziawg_en.sh
  wget -O /root/awg/awg_common.sh https://raw.githubusercontent.com/bootkiTdll/amneziawg-installer-fork/main/awg_common_en.sh
  chmod 700 /root/awg/manage_amneziawg.sh /root/awg/awg_common.sh
  </pre>
